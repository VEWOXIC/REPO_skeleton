...
# Cell
class TST(Module):
    def __init__(self, cfg, max_seq_len:Optional[int]=None, d_k:Optional[int]=None, 
                 d_v:Optional[int]=None, y_range:Optional[tuple]=None, **kwargs):
        ...
        self.head = self.create_head(self.head_nf, c_out * seq_len, act=act, fc_dropout=fc_dropout, y_range=y_range)
