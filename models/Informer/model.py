...
class Informer(nn.Module):
    def __init__(self,cfg):
        ...
        self.e_layers=cfg['model']['e_layers']
        self.d_layers=cfg['model']['d_layers']
        self.d_ff=cfg['model']['d_ff']
        self.attn=cfg['model']['attn']
        self.factor=cfg['model']['factor']
        self.embed=cfg['model']['embed']
        self.enc_in=cfg['model']['enc_in']
        self.freq=cfg['model']['freq']
        self.dropout=cfg['model']['dropout']
        self.distil=cfg['model']['distil']
        self.activation=cfg['model']['activation']
        self.dec_in=cfg['model']['dec_in']
        self.c_out=cfg['model']['c_out']
        self.mix=cfg['model']['mix']
        ...
        self.dec_embedding = DataEmbedding(self.enc_in, self.d_model, self.embed, self.freq, self.dropout)
        # Attention
