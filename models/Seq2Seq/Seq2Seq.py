...
class Seq2Seq(nn.Module):
    ...
    def forward(self, input, target, input_time, target_time):
        ...
        trainx = trainx.permute(1, 0, 2, 3) # [input_window, batch_size, num_nodes, feature_dim]
        src = trainx.float()
        ...
        trainy = trainy.permute(1, 0, 2, 3) # [output_window, batch_size, num_nodes, feature_dim]
        target = trainy.float()
